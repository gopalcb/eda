(() => {
        ...
        if (app.validate_login_form(data)) {
            ...
            request.done(function (response, textStatus, jqXHR){
                ...
                if (ok) {
                    ...
                    window.location.href = baseurl + '/my_appointments';
                }
                else {
        ...
        request.done(function (response, textStatus, jqXHR){
            ...
            if (ok) {
                ...
                ratings.forEach(function(obj) {
                    ...
                    let approve = `<a class="approve-rating" data-id="`+obj.id+`" href="#">Approve</a>  •  `;
                    if (obj.approve) {
                        approve = '';
                    }
                ...
                $('.approve-rating').unbind().bind('click', function() {
                    ...
                    let req = app.post('/approve_comments/'+id, {});
    ...
    app.list_files = () => {
        ...
        request.done(function (response, textStatus, jqXHR){
            ...
            if (ok) {
                ...
                files.forEach(function(file) {
                    ...
                    let tr = `
                        <tr>
                            <td>`+file+`</td>
                            <td>
                                 <a class="view-file" data-file="`+file+`" href="#">View</a>  •
                ...
                $('.view-file').unbind().bind('click', function() {
    ...
    $('.btn-upload-files').change(function() {
